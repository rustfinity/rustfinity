...
pub fn clean_string(s: &str) -> String {
    ...
    // Hint: Use .trim() and .to_lowercase()
    unimplemented!()
}
...
pub fn contains_word(text: &str, word: &str) -> bool {
    ...
    // Hint: Convert both to the same case, then use .contains()
    unimplemented!()
}
...
pub fn split_and_trim(s: &str, delimiter: char) -> Vec<String> {
    ...
    // Hint: Use .split(), .map(), .trim(), and .collect()
    unimplemented!()
}
...
pub fn normalize_whitespace(s: &str) -> String {
    ...
    // Hint: Use .split_whitespace() and .join(" ")
    unimplemented!()
}
