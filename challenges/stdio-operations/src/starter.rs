...
pub fn read_line_from_reader<R: BufRead>(mut reader: R) -> io::Result<String> {
    // TODO: Read a single line from the reader into a String buffer
    // Hint: Use reader.read_line(&mut buffer) to read the line
    // Remember to trim trailing newline characters (\n and \r\n)
    unimplemented!()
}
...
pub fn read_all_lines_from_reader<R: BufRead>(reader: R) -> io::Result<Vec<String>> {
    // TODO: Read all lines from the reader into a Vec<String>
    // Hint: Use the lines() iterator from BufRead and collect()
    unimplemented!()
}
...
pub fn write_to_writer<W: Write>(writer: &mut W, message: &str) -> io::Result<()> {
    // TODO: Write the message to the writer without adding a newline
    // Hint: Use write!() macro or writer.write_all()
    unimplemented!()
}
...
pub fn writeln_to_writer<W: Write>(writer: &mut W, message: &str) -> io::Result<()> {
    // TODO: Write the message with a newline appended
    // Hint: Use writeln!() macro
    unimplemented!()
}
...
pub fn write_and_flush<W: Write>(writer: &mut W, message: &str) -> io::Result<()> {
    // TODO: Write the message and then flush the buffer
    // Hint: Call writer.flush() after writing
    unimplemented!()
}
...
pub fn write_error_to_writer<W: Write>(writer: &mut W, error: &str) -> io::Result<()> {
    // TODO: Write the error in format "[ERROR] {message}\n"
    // Hint: Use writeln!() with formatting
    unimplemented!()
}
